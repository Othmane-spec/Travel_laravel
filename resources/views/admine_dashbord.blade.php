    ...
    <section class="dashboard-area">
        ...
        <div class="dashboard-content-wrap">
                            ...
                            <div class="icon-box icon-layout-2 dashboard-icon-box pb-0">
                                <div class="d-flex pb-3 justify-content-between">
                                    <div class="info-content">
                                        ...
                                        <h4 class="info__title">{{ App\Models\Booking::count() }}</h4>
                            ...
                            <div class="icon-box icon-layout-2 dashboard-icon-box pb-0">
                                <div class="d-flex pb-3 justify-content-between">
                                    <div class="info-content">
                                        ...
                                        <h4 class="info__title">{{ App\Models\Testimonial::count() }}</h4>
                                    </div><!-- end info-content -->
                            ...
                            <div class="icon-box icon-layout-2 dashboard-icon-box pb-0">
                                <div class="d-flex pb-3 justify-content-between">
                                    <div class="info-content">
                                        ...
                                        <h4 class="info__title">{{ App\Models\User::count() }}</h4>
                                    </div><!-- end info-content -->
                            ...
                            <div class="icon-box icon-layout-2 dashboard-icon-box pb-0">
                                <div class="d-flex pb-3 justify-content-between">
                                    <div class="info-content">
                                        ...
                                        <h4 class="info__title">{{ App\Models\Hotel::count() }}</h4>
                                    </div><!-- end info-content -->
            ...
            <div class="dashboard-main-content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-7 responsive-column--m mt-3">
                            <div class="form-box dashboard-card">
                                <div class="form-title-wrap">
                                    <h3 class="title">{{ $chart->options['chart_title'] }}</h3>
                                </div>
                        ...
                        <div class="col-lg-6 responsive-column--m">
                            <div class="form-box dashboard-card">
                                <div class="form-title-wrap">
                                    <h3 class="title">{{ $chart1->options['chart_title'] }}</h3>
                                </div>
                                <div class="form-content">
                                    {!! $chart1->renderHtml() !!}
                                </div>
