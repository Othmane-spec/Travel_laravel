                    ...
                    <div class="contact-form-action">
                        <form method="post"  action="{{ route('register') }}">
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <span class="la la-envelope form-icon"></span>
                                    <input class="form-control" type="number" name="phone" placeholder="Type your phone number">
                                    @error('phone')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <span class="la la-lock form-icon"></span>
                                    <input class="form-control" type="text" name="password" placeholder="Type again password">
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
