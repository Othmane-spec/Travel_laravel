                ...
                <div class="col-lg-6">
                    <div class="header-top-content">
                        <div class="header-right d-flex align-items-center justify-content-end">
                            ...
                            <div class="header-right-action">
                                @if (Auth::user('login'))
                                    <a href="{{ route('logout') }}" class="theme-btn theme-btn-small">Logout</a>
                                @else
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="menu-wrapper">
                        ...
                        <div class="main-menu-content">
                            <nav>
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{ route('hotel-list') }}">Hotel </a>
                                        {{-- <ul class="dropdown-menu-item">
                        ...
                        {{-- <div class="nav-btn">
                            <p class="theme-btn theme-btn-small theme-btn-transparent">
                                <i class="la la-heart mr-2">Wishlist<span
                                        class="badge badge-danger add_wishlist"></span></i>
