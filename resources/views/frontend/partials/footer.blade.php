        ...
        <div class="row">
            <div class="col-lg-3 responsive-column">
                <div class="footer-item">
                    ...
                    <p class="footer__desc">Lorem convallis bibendum urna ut viverra. Maecenas consequat</p>
                    <ul class="list-items pt-3">
                        <li>3015 Grand Casablanca, Coconut Grove,<br> Rue les Far, 12345</li>
                        <li>+212-456-789</li>
                        <li><a href="#">trizen@gmailwebsite.com</a></li>
                    </ul>
                </div><!-- end footer-item -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
