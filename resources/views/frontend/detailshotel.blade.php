                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-list breadcrumb-top-list">
                        <ul class="list-items bg-transparent radius-none p-0">
                            ...
                            {{-- <li>France</li> --}}
                            <li>{{ $hotel->name }} Hotel and Resorts</li>
                        </ul>
                    ...
                    <div class="col-lg-12">
                        <div class="breadcrumb-btn">
                            <div class="btn-box">
                                ...
                                <a class="theme-btn" data-src="/images/img1.jpg" data-fancybox="gallery"
                        ...
                        <div class="single-content-nav" id="single-content-nav">
                            <ul>
                                <li><a data-scroll="description" href="#description" class="scroll-link active">Hotel
                                        Details</a></li>
                                {{-- <li><a data-scroll="availability" href="#availability"
                                        class="scroll-link">Availability</a></li> --}}
                ...
                <div class="row">
                        ...
                        <div class="single-content-wrap padding-top-60px">
                            <div id="description" class="page-scroll">
                                <div class="single-content-item pb-4">
                                    <h3 class="title font-size-26">{{ $hotel->name }} Hotel and Resorts</h3>
                                    <div class="d-flex align-items-center pt-2">
                                        <p class="mr-2">{{ $hotel->address }}</p>
                                        <p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 responsive-column">
                                            <div class="single-tour-feature d-flex align-items-center mb-3">
                                                ...
                                                <div class="single-feature-titles">
                                                    <h3 class="title font-size-15 font-weight-medium">Adress</h3>
                                                    <span class="font-size-13">{{ $hotel->address }}</span>
                                                </div>
                                            </div><!-- end single-tour-feature -->
                                        </div><!-- end col-lg-4 -->
                                        <div class="col-lg-4 responsive-column">
                                ...
                                <div class="single-content-item padding-top-40px padding-bottom-40px">
                                    <h3 class="title font-size-20">About {{ $hotel->name }} Hotel</h3>
                                    <p class="py-3">{{ $hotel->details }}.</p>
                                </div><!-- end single-content-item -->
                                <div class="section-block"></div>
                            </div><!-- end description -->
                                            ...
                                            <div class="cabin-type-detail">
                                                ...
                                                <div class="room-photos">
                                                    ...
                                                    <a class="d-none" data-fancybox="gallery"
                                                        data-src="/images/img2.jpg" data-caption="Showing image - 02"
                                                        data-speed="700"></a>
                                                    <a class="d-none" data-fancybox="gallery"
                                                        data-src="/images/img3.jpg" data-caption="Showing image - 03"
                                                        data-speed="700"></a>
                                                    <a class="d-none" data-fancybox="gallery"
                                                        data-src="/images/img4.jpg" data-caption="Showing image - 04"
                                                        data-speed="700"></a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="cabin-type padding-top-30px">
                                        <div class="cabin-type-item seat-selection-item d-flex">
                                            ...
                                            <div class="cabin-type-detail">
                                                ...
                                                <div class="room-photos">
                                                    <a class="btn theme-btn-hover-gray" data-src="/img1.jpg"
                                                        data-fancybox="gallery" data-caption="Showing image - 01"
                                                        data-speed="700">
                                                        <i class="la la-photo mr-2"></i>Room Photos
                                                    </a>
                                    ...
                                    <div class="accordion accordion-item padding-top-30px" id="accordionExample2">
                                            ...
                                            <div class="card-header" id="faqHeadingFour">
                                                <h2 class="mb-0">
                                                    <button
                                                        ...
                                                        aria-expanded="true" aria-controls="faqCollapseFour">
                                                        <span class="ml-3">How do I know a reservation is
                                                            accepted or confirmed?</span>
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="faqCollapseFive" class="collapse"
                                                aria-labelledby="faqHeadingFive" data-parent="#accordionExample2">
                                                <div class="card-body d-flex">
                                                    <p>Mea appareat omittantur eloquentiam ad, nam ei quas oportere
                                                        democritum. Prima causae admodum id est, ei timeam inimicus sed. Sit
                                                        an meis aliquam, cetero inermis vel ut. An sit illum euismod
                                            ...
                                            <div class="card-header" id="faqHeadingSix">
                                                <h2 class="mb-0">
                                                    <button
                                                        ...
                                                        <span class="ml-3">What happens if I let a reservation
                                                            request expire?</span>
                                                        <i class="la la-minus"></i>
                                                        <i class="la la-plus"></i>
                                                    </button>
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="faqHeadingSeven">
                                                <h2 class="mb-0">
                                                    <button
                                                        class="btn btn-link d-flex align-items-center justify-content-end flex-row-reverse font-size-16"
                                                        type="button" data-toggle="collapse" data-target="#faqCollapseSeven"
                                                        aria-expanded="false" aria-controls="faqCollapseSeven">
                                                        <span class="ml-3">How do I set reservation
                                                            requirements?</span>
                                                        <i class="la la-minus"></i>
                                                        <i class="la la-plus"></i>
                                                    </button>
                                            ...
                                            <div id="faqCollapseSeven" class="collapse"
                                                aria-labelledby="faqHeadingSeven" data-parent="#accordionExample2">
                                                <div class="card-body d-flex">
                                                    <p>Mea appareat omittantur eloquentiam ad, nam ei quas oportere
                                                        democritum. Prima causae admodum id est, ei timeam inimicus sed. Sit
                                                        an meis aliquam, cetero inermis vel ut. An sit illum euismod
                                            ...
                                            <div class="comment-body">
                                                ...
                                                <div
                                                    ...
                                                    <div class="reviews-reaction">
                                                        ...
                                                        <a href="#" class="comment-love"><i class="la la-heart-o"></i>
                                                            5</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-box">
                                            ...
                                            <div class="form-content">
                                                ...
                                                <div class="contact-form-action">
                                                    <form method="POST"
                                                        action="{{ url('/save-testimonial', $hotel->id) }}"
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar single-content-sidebar mb-0">
                                ...
                                <div class="sidebar-widget single-content-widget">
                                    ...
                                    <div class="sidebar-widget-item">
                                        <div class="sidebar-book-title-wrap mb-3">
                                            ...
                                            <p><span class="text-form">From</span><span class="text-value ml-2 mr-1"
                                                    id="updateprice" name="price">{{ $hotel->price }}</span> <span
                                                ...
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="date-range form-control" type="text" name="daterange"
                                                            readonly value="{{ $hotel->daterange }}">
                                                    </div>
                                                </div>
                                                <div class="input-box">
                                                    <label class="label-text">Rooms</label>
                                                    <div class="form-group">
                                                        <div class="select-contain w-auto">
                                                            <select class="select-contain-select" name="Nbrooms">
                                                                <option value="0">Select Rooms</option>
                                                                <option value="1">1 Room</option>
                                                                <option value="2">2 Rooms</option>
                                                                <option value="3">3 Rooms</option>
                                    ...
                                    <div class="sidebar-widget-item">
                                        <div class="qty-box mb-2 d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="qtyBtn d-flex align-items-center">
                                                ...
                                                <input type="number" name="total_adults" value="0">
                                        ...
                                        <div class="qty-box mb-2 d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="qtyBtn d-flex align-items-center">
                                                <div class="qtyDec"><i class="la la-minus"></i></div>
                                                <input type="number" name="total_children" value="0">
                                                <div class="qtyInc"><i class="la la-plus"></i></div>
                                            </div>
                                        </div><!-- end qty-box -->
                                    ...
                                    <div class="btn-box pt-2">
                                        <button type="submit" class="theme-btn text-center w-100 mb-2"><i
                                                class="la la-shopping-cart mr-2 font-size-18"></i>Book
                                            Now</button>
                                        @if (session('success'))
                                            <a href="{{ route('checkouthotel', $hotel->slug) }}"
                                                class="theme-btn text-center w-100 mb-2"><i
                                                    class="fa fa-chevron-circle-right mr-2 font-size-18"></i>Checkout</a>
                                        @endif

                                        {{-- @if (Session::has('data'))
                                            <input type="hidden" name="user_id" value="{{ session('data')[0]->id }}" />
                                        ...
                                        {{-- <div class="d-flex align-items-center justify-content-between pt-2">
                                            <a href="#" class="btn theme-btn-hover-gray font-size-15" data-toggle="modal"
                                                data-target="#sharePopupForm"><i class="la la-share mr-1"></i>Share</a>
                            ...
                            <div class="sidebar-widget single-content-widget mt-5">
                                                    ...
                                                    <div class="input-box">
                                                        <div class="form-group">
                                                            <div class="custom-checkbox mb-0">
                                                                ...
                                                                <label for="agreeChb">I agree with <a href="#">Terms of
                                                                        Service</a> and
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="author-bio">
                                            ...
                                            <div class="btn-box pt-3">
                                                <a href="#" class="theme-btn theme-btn-small theme-btn-transparent">Ask a
                                                    Question</a>
                                            </div>
                                        </div>
                                    </div>
    ...
    <section class="related-tour-area section--padding">
        <div class="container">
            ...
            <div class="row padding-top-50px">
                @foreach (\App\Models\Hotel::limit(3)->get() as $hotel)
                    <div class="col-lg-4 responsive-column">

                        <div class="card-item">
                            <div class="card-img">
                                <a href="{{ route('detailshotel', $hotel->slug) }}" class="d-block">
                                    <img src="{{ asset($hotel->photo) }}" alt="hotel-img">
                                </a>
                            ...
                            <div class="card-body">
                                <h3 class="card-title"><a href="hotel-single.html">{{ $hotel->name }}</a></h3>
