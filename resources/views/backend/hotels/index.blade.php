                            ...
                            <div class="form-box">
                                <div class="form-title-wrap">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="{{ route('hotel.create') }} " class="btn btn-primary"> Add new
                                            hotel</a>
                                    </div>
                                </div>
                                        ...
                                        <div class="card-item card-item-list card-item--list">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <ul class="list-items list-items-2 pt-2 pb-3">
                                                    <li><span>Start date&End date:</span>{{ $hotel->daterange }}</li>
                                                    <li><span>Booking details:
                                                        </span>{{ Str::limit($hotel->details, 50) }} </li>
                                                    <li><span>Price: </span>{{ $hotel->price }}</li>
                                                    <li><span>Types of the room: </span>{{ $hotel->room_type->name }}
                                                    </li>
                                            ...
                                            <div class="action-btns">
                                                <a href="{{ route('hotel.edit', encrypt($hotel->id)) }}"
                                                    class="theme-btn theme-btn-small mr-2 mb-3"><i
                                                        class="la la-check-circle mr-1"></i>Edit</a>
                                                ...
                                                <form action="{{ route('hotel.destroy', $hotel->id) }}"
                                                    ...
                                                    <button type="submit" class="btn btn-danger btn-sm"
                                                        data-toggle="modal" data-target="#signupPopupForm"><i
                                                            class="la la-times mr-1"></i>Delete</button>
