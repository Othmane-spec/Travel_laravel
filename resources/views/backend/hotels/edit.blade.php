                        ...
                        <div class="col-lg-12">
                            <div class="form-box">
                                <div class="form-title-wrap">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h3 class="title">Edit Information hotel :</h3>
                                ...
                                <div class="form-content pb-2">
                                    <div class="pt-2">
                                        <form method="post" action="{{ route('hotel.update', $hotel->id) }}"
                                            ...
                                            <h6 class="mb-5">l'image precedente :</h6>
                                            <img src=" {{ asset($hotel->photo) }}" alt="" width="25%">
                                            <div class="mb-3 py-2">
                                                <label class="form-label" for="unp-hotel-details">Details</label>
                                                <textarea class="form-control @error('details') is-invalid @enderror"
                                                    rows="6" id="unp-hotel-details"
                                                    name="details">{{ $hotel->details }}</textarea>
                                                @error('details')
                                                    <strong class="text-danger">{{ $message }}</strong>
                                                @enderror
                                            </div>
                                            ...
                                            <button class="btn btn-primary ml-5 " type="submit"><i
                                                    class="ci-cloud-upload fs-lg me-2"></i>Edit Hotel
                                            </button>
                                        </form>
                                    </div>
                                </div>
