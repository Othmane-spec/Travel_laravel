                    ...
                    <div class="col-lg-12">
                        <div class="form-box">
                            <div class="form-title-wrap">
                                <div class="d-flex align-items-center justify-content-between">
                                    <h3 class="title"> Category Results :</h3>
                                    ...
                                    <a href="{{route('room_types.create')}}" class="btn btn-primary">Add new Category</a>
                                </div>
                            </div>
                           <div class="col-md-10">

                               <div class="form-content">
                                <div class="table-form table-responsive offset-1">
                                    <table class="table">
                                        <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="table-content">
                                                    <h3 class="title">{{ $room_type->name }}</h3>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="table-content">
                                                    ...
                                                    {{-- <a href="#" class="btn btn-primary btn-small mr-2 mb-3"  title="Edit"><i class="la la-edit"></i></a> --}}


                                                        <form action="{{route('room_types.destroy', $room_type->id)}}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button href="#" type="submit" class=" btn btn-danger btn-small "><i class="la la-times "></i></button>
