        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 responsive-column">
                    <div class="icon-box faq-icon-box">
                        <a href="#" class="d-block">
                            <svg class="info-svg" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px"
                ...
                <div class="col-lg-3 responsive-column">
                    <div class="icon-box faq-icon-box">
                        <a href="#" class="d-block">
                            <svg class="info-svg" version="1.1" id="Capa_2" xmlns="http://www.w3.org/2000/svg" x="0px"
                                y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;"
                                xml:space="preserve">
                                <g>
                                    <g>
                ...
                <div class="col-lg-3 responsive-column">
                    <div class="icon-box faq-icon-box">
                        <a href="#" class="d-block">
                            <svg class="info-svg" version="1.1" id="Capa_3" xmlns="http://www.w3.org/2000/svg" x="0px"
                ...
                <div class="col-lg-3 responsive-column">
                    <div class="icon-box faq-icon-box">
                        <a href="#" class="d-block">
                            <svg class="info-svg" version="1.1" id="Capa_4" xmlns="http://www.w3.org/2000/svg" x="0px"
                                y="0px" viewBox="0 0 412.72 412.72" style="enable-background:new 0 0 412.72 412.72;"
                                xml:space="preserve">
                                <g>
                                    <g>
                                        <path
                ...
                <div class="col-lg-3 responsive-column">
                    <div class="icon-box faq-icon-box">
                        <a href="#" class="d-block">
                            <svg class="info-svg" id="Capa_5" enable-background="new 0 0 511.996 511.996"
                ...
                <div class="col-lg-3 responsive-column">
                    <div class="icon-box faq-icon-box">
                        <a href="#" class="d-block">
                            <svg class="info-svg" version="1.1" id="Capa_6" xmlns="http://www.w3.org/2000/svg" x="0px"
                                y="0px" viewBox="0 0 480.1 480.1" style="enable-background:new 0 0 480.1 480.1;"
                                xml:space="preserve">
                                <g>
                                    <g>
                                        <path
                ...
                <div class="col-lg-3 responsive-column">
                    <div class="icon-box faq-icon-box">
                        <a href="#" class="d-block">
                            <svg class="info-svg" version="1.1" id="Capa_7" xmlns="http://www.w3.org/2000/svg" x="0px"
                                y="0px" viewBox="0 0 507.996 507.996" style="enable-background:new 0 0 507.996 507.996;"
                                xml:space="preserve">
                                <g>
                                    <g>
                ...
                <div class="col-lg-3 responsive-column">
                    <div class="icon-box faq-icon-box">
                        <a href="#" class="d-block">
                            <svg class="info-svg" version="1.1" id="Capa_8" xmlns="http://www.w3.org/2000/svg" x="0px"
                                y="0px" viewBox="0 0 511.997 511.997" xml:space="preserve">
                                <g>
                                    <g>
                        ...
                        <ul class="toggle-menu list-items list-items-flush pt-4">
                            <li>
                                ...
                                <ul class="toggle-drop-menu pt-2">
                                    <li class="line-height-26">Suspendisse ullamcorper lacus et commodo laoreet. Sed sodales
                                        aliquet felis, quis volutpat massa imperdiet in. Praesent rutrum malesuada risus,
                                        ullamcorper pretium tortor</li>
                                </ul>
                            </li>
                            <li>
                                <a href="#" class="toggle-menu-icon d-flex justify-content-between align-items-center">
                    ...
                    <div class="faq-item mb-5">
                        ...
                        <ul class="toggle-menu list-items list-items-flush pt-4">
                            <li>
                                ...
                                <ul class="toggle-drop-menu pt-2">
                                    <li class="line-height-26">Suspendisse ullamcorper lacus et commodo laoreet. Sed
                                        sodales aliquet felis, quis volutpat massa imperdiet in. Praesent rutrum malesuada
                                        risus, ullamcorper pretium tortor</li>
                                </ul>
                            </li>
                            <li>
                                <a href="#" class="toggle-menu-icon d-flex justify-content-between align-items-center">
